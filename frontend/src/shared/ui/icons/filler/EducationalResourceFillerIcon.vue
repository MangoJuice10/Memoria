<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="61.402" height="79.273" viewBox="-5 -10 61.402 79.273">
    ...
    <g style="opacity:1">
      <path
          d="M30.063 12.684v70.03h48.699c1.277 0 2.347-1.07 2.347-2.347l.004-65.336a2.366 2.366 0 0 0-2.347-2.347h-2.04zm3 3h45.05l-.004 64.03H33.063Z"
    ...
    <g style="opacity:1">
      <path
          d="M26.512 5.025c-3.74 0-6.801 3.003-6.801 6.673v63.666c0 4.04 3.371 7.355 7.496 7.355h2.91V14.076h-3.61c-1.351 0-2.421-1.048-2.421-2.378 0-1.339 1.074-2.385 2.426-2.385h52.414c1.195 0 2.187-.99 2.187-2.144 0-1.153-.992-2.144-2.187-2.144zM22.71 15.471a5.45 5.45 0 0 0 3.797 1.545h.61V79.76c-2.456-.049-4.407-1.975-4.407-4.397z"
          style="baseline-shift:baseline;display:inline;overflow:visible;vector-effect:none;fill:var(--color-icon-default);stroke-width:1;paint-order:stroke fill markers;stop-color:var(--color-icon-inverse);stop-opacity:1"
          transform="translate(-24.71 -14.235)"/>
      <path
